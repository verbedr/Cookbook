...
namespace Cookbook.ServiceTests
{
    public static class AsyncQueriesExtensions
    {
        public static IQueryable<T> AsAsyncQueryable<T>(this IEnumerable<T> list)
        {
    ...
    public class TestDbAsyncEnumerable<T> : EnumerableQuery<T>, IDbAsyncEnumerable<T>, IQueryable<T>
    {
        ...
        public virtual IDbAsyncEnumerator<T> GetAsyncEnumerator()
        {
